/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 39d3924135862ab2af0007e874c4cf0d)
...
interface __BaseEnv_Env {
	...
	MEDIA_URL: string;
	CMS_URL: string;
	CMS: Service /* entrypoint CmsService from citadel-cms */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SECRET" | "ADMIN_EMAIL" | "MEDIA_URL" | "CMS_URL">> {}
}
