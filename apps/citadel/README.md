...
Citadel is Cadmus's reference implementation: define content as collections
in `citadel.config.ts` (the equivalent of a `payload.config.ts`) and get a
...
- **Worker 2** — TanStack Start CMS (your generated admin interface)
